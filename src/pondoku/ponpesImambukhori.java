 ...
 * @author HP
 */
public class ponpesImambukhori extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesImambukhori() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/salafy/ponpes imam bukhari.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesImambukhori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesImambukhori().setVisible(true);
            }
        });
    }
