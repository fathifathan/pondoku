 ...
 * @author HP
 */
public class gontor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/bahasa/ponpes gontor.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gontor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                gontor gontor = new gontor();
                gontor.setLocationRelativeTo(null);
                gontor.setVisible(true);
            }
        });
    }
