 ...
 * @author HP
 */
public class ponpesIsykarima extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesIsykarima() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/modern/ponpes isy karima.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesIsykarima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesIsykarima().setVisible(true);
            }
        });
    }
