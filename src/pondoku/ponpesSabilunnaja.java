 ...
 * @author HP
 */
public class ponpesSabilunnaja extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesSabilunnaja() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/salafy/ponpes sabilunnajah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesSabilunnaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesSabilunnaja().setVisible(true);
            }
        });
    }
