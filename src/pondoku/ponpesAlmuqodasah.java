 ...
 * @author HP
 */
public class ponpesAlmuqodasah extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesAlmuqodasah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/modern/ponpes almuqodasah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesAlmuqodasah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesAlmuqodasah().setVisible(true);
            }
        });
    }
