 ...
 * @author HP
 */
public class ponpesAluqmaniyah extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesAluqmaniyah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/kitab/ponpes luqmaniyah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesAluqmaniyah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesAluqmaniyah().setVisible(true);
            }
        });
    }
