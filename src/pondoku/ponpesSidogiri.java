 ...
 * @author HP
 */
public class ponpesSidogiri extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesSidogiri() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/salafy/ponpes sidogiri.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesSidogiri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesSidogiri().setVisible(true);
            }
        });
    }
