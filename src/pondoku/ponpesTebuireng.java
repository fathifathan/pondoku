 ...
 * @author HP
 */
public class ponpesTebuireng extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesTebuireng() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/salafy/ponpes tebu ireng.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesTebuireng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesTebuireng().setVisible(true);
            }
        });
    }
