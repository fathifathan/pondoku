 ...
 * @author HP
 */
public class ponpesYanbuulquraan extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesYanbuulquraan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/modern/ponpes yanbuul quran.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesYanbuulquraan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesYanbuulquraan().setVisible(true);
            }
        });
    }
