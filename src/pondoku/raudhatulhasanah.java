 ...
 * @author HP
 */
public class raudhatulhasanah extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public raudhatulhasanah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/bahasa/ponpes raudhatul hasanah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(raudhatulhasanah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new raudhatulhasanah().setVisible(true);
            }
        });
    }
