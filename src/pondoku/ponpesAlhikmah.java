 ...
 * @author HP
 */
public class ponpesAlhikmah extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesAlhikmah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/kitab/ponpes alhikmah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesAlhikmah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesAlhikmah().setVisible(true);
            }
        });
    }
