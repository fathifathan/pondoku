 ...
 * @author HP
 */
public class ponpesAlmunawwir extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesAlmunawwir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/kitab/ponpes almunawir.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesAlmunawwir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesAlmunawwir().setVisible(true);
            }
        });
    }
