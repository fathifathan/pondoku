 ...
 * @author HP
 */
public class ponpesAlmakiyah extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesAlmakiyah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/kitab/ponpes al makiyah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesAlmakiyah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesAlmakiyah().setVisible(true);
            }
        });
    }
