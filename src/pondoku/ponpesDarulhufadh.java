 ...
 * @author HP
 */
public class ponpesDarulhufadh extends javax.swing.JFrame {

    /**
     * Creates new form ponpesDaqu
     */
    public ponpesDarulhufadh() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/modern/ponpes darul hufadh.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ponpesDarulhufadh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ponpesDarulhufadh().setVisible(true);
            }
        });
    }
